...
func NewRoomServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) RoomService {
	...
	serviceURL += baseServicePath(pathPrefix, "vc", "RoomService")
	urls := [11]string{
...
const RoomServicePathPrefix = "/twirp/vc.RoomService/"
...
func (s *roomServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "vc", "RoomService")
}
...
var twirpFileDescriptor2 = []byte{
	...
	,
}
