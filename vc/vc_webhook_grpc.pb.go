...
const (
	WebHookService_WebHook_FullMethodName = "/vc.WebHookService/WebHook"
)
...
type WebHookServiceClient interface {
	WebHook(ctx context.Context, in *WebhookEvent, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *webHookServiceClient) WebHook(ctx context.Context, in *WebhookEvent, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, WebHookService_WebHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWebHookServiceServer) WebHook(context.Context, *WebhookEvent) (*Empty, error) {
...
func _WebHookService_WebHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WebHookService_WebHook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebHookServiceServer).WebHook(ctx, req.(*WebhookEvent))
	}
